---
title: "Tutorial: Recreatea a NY Times Chart in R"
...
Since we are recreating the chart, we need to identify the exact colors from the original. For this chart, we can find the colors by [inspecting the page](https://developer.chrome.com/docs/devtools/inspect-mode) and selecting the colored elements to see the assigned hex codes.
